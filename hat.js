...
function AnnotationCanvas(element, options) {
  ...
  function create() {
    ...
    var keys = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '10', '11', '12','13','14','15','16','17','18',
...
'#0f9','#0f0','#ff0','#f60','#f00','#f06','#f0f','#f9f','#00f','#06f','#09f','#0ff','#099',
'#0f9','#0f0','#ff0','#f60','#f00','#f06','#f0f','#f9f''#00f','#06f','#09f','#0ff','#099',
'#0f9','#0f0','#ff0','#f60','#f00','#f06','#f0f','#f9f','#0ff','#099',
'#0f9','#0f0','#ff0','#f60','#f00','#f06','#f0f','#f9f'];
